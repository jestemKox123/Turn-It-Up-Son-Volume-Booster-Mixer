...
(function () {
  const DICT = {
    pl: {
      ...
      sec_limiter: "Limiter",
      limiter_h: "Limiter",
      limiter_d: "Pilnuje, żeby dźwięk nie przesterował przy mocnym podbiciu. Sam z siebie nic nie robi: budzi się dopiero wtedy, gdy muzyka dobija do sufitu. Przy 200% i wyżej bez niego robi się wyraźnie brudno, bo szczyty ścina wtedy już samo nasycenie.",
    ...
    en: {
      ...
      sec_limiter: "Limiter",
      limiter_h: "Limiter",
      limiter_d: "Keeps the sound from distorting on heavy boost. It does nothing on its own: it only wakes up when the music reaches the ceiling. From 200% up, turning it off gets clearly dirty, because then only saturation is shaving the peaks.",
